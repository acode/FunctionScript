...
class Gateway extends EventEmitter {
  ...
  constructor(cfg) {
    ...
    this.supportedBgModes = {
      'info': (req, params) => 'Background Function Initiated',
  ...
  __background__(req, res, params) {
    let value = req._background(req, params);
    ...
    req.on('end', () => {
      ...
      this.resolve(req, res, buffer, (err, definition, data, buffer) => {
        ...
        if (req._background) {
          ...
          this.__background__(req, res, validated.params);
        }
