...
class Gateway extends EventEmitter {
  ...
  __streamError__ (executionUuid, eventName) {
  ...
  __streamParameterError__ (executionUuid, eventName, details) {
    let req = this._requests[executionUuid];
  ...
  __stream__ (streams, executionUuid, eventName, value) {
    ...
    if (!stream) {
      this.__streamError__(executionUuid, eventName);
    } else {
      ...
      if (
        ...
        this.__streamParameterError__(executionUuid, eventName, details);
      } else {
        try {
